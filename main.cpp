...
char* g_szApplicationName = "Scrabble";
                             ...
                             LPARAM lParam)
{
   ...
   static HBITMAP	hOldBitmap;
    ...
    case WM_CREATE:
      {
		 ...
		 //initialize the game
		 InitializeGame(cxClient,cyClient);
    ...
    case WM_LBUTTONUP:
    {
		LeftMouseClickEvent(MAKEPOINTS(lParam));
    }	
	...
	case WM_RBUTTONUP:
    {
		RightMouseClickEvent(MAKEPOINTS(lParam));
    }	
	...
	case WM_MOUSEMOVE:
	{
		ChangeMousePosition(MAKEPOINTS(lParam));
	}
	break;
                    ...
                    int       iCmdShow)
{
  ...
  winclass.lpszMenuName  = MAKEINTRESOURCE(101); //note: this might not be correct
  ...
  {
    MessageBox(NULL, "Window Class Registration Failed!", "Error", 0);
